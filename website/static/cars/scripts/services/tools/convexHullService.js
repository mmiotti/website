(function () {
  ...
  angular.module('interactiveCostCarbonApp')
    .factory('convexHullService', ['legendAndColors', convexHullService]);

  function convexHullService(legendAndColors) {
    ...
    function calculateHull(results, configValues, colorKey) {
      ...
      for (var i = 0; i < results.length; ++i) {
        ...
        if (results[i][configValues.legendColorField].trim() === colorKey && !legendAndColors.isFiltered(results[i], configValues)) {

(function () {
  ...
  function calculateResults(configService) {
    ...
    function calculate(myData) {
      ...
      // set GHG intensity of electricity for fuel production/distribution to that of vehicle production/distribution (not distinguished at this point)
      //configValues.electricity_ghg_fuel = configValues.electricity_ghg_veh;
